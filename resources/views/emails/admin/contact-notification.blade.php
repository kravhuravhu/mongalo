...
@section('body')
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding: 28px 36px 24px;">
        <tr>
            <td>
                <h2 style="font-family: 'Georgia', serif; font-weight: 700; font-size: 20px; color: #1a1a2e; margin: 0 0 4px 0;">New Contact Message</h2>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #f7f5f2; border-radius: 10px; padding: 16px 20px; border: 1px solid rgba(166, 124, 78, 0.06); margin-bottom: 16px;">
                    <tr>
                        <td>
                            <h4 style="font-family: 'Georgia', serif; font-weight: 700; font-size: 14px; color: #a67c4e; margin: 0 0 10px 0;">&#128100; Sender Details</h4>

                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06);">Name</td>
                                    <td style="font-weight: 600; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right;">{{ $message->name }}</td>
                                </tr>
                                <tr>
                                    <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06);">Email</td>
                                    <td style="font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right; color: #6a6a7a;">{{ $message->email }}</td>
                                </tr>
                                @if($message->phone)
                                    <tr>
                                        <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06);">Phone</td>
                                        <td style="font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right; color: #6a6a7a;">{{ $message->phone }}</td>
                                    </tr>
                                @endif
                                <tr>
                                    <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06);">Subject</td>
                                    <td style="font-weight: 600; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right; color: #a67c4e;">{{ $message->subject }}</td>
                                </tr>
                                <tr>
                                    <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06);">Submitted</td>
                                    <td style="font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right; color: #6a6a7a;">{{ $message->created_at->format('F d, Y g:i A') }}</td>
                                </tr>
                                <tr>
                                    <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding-top: 6px; vertical-align: top;">Message</td>
                                    <td style="font-weight: 400; font-size: 12px; padding: 6px 0 0 0; text-align: right; color: #6a6a7a; line-height: 1.6; background: #ffffff; border-radius: 6px; padding: 8px 12px; border-left: 3px solid #a67c4e; margin-top: 4px;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td align="center" style="padding: 4px 0;">
                            <a href="{{ route('admin.messages.show', $message) }}" style="display: inline-block; padding: 10px 32px; border-radius: 50px; background: #a67c4e; color: #ffffff; font-weight: 600; font-size: 14px; text-decoration: none; border: none; cursor: pointer; text-align: center;">
                                &#128065; View in Admin
                            </a>
                        </td>
                    </tr>
