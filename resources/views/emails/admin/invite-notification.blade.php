...
@section('body')
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding: 28px 36px 24px;">
        <tr>
            <td>
                <h2 style="font-family: 'Georgia', serif; font-weight: 700; font-size: 20px; color: #1a1a2e; margin: 0 0 4px 0;">New Invite Request</h2>
                ...
                {{-- ─── REQUESTER DETAILS ─── --}}
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #f7f5f2; border-radius: 10px; padding: 16px 20px; border: 1px solid rgba(166, 124, 78, 0.06); margin-bottom: 12px;">
                    <tr>
                        <td>
                            <h4 style="font-family: 'Georgia', serif; font-weight: 700; font-size: 14px; color: #a67c4e; margin: 0 0 10px 0;">&#128100; Requester Details</h4>

                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06);">Name</td>
                                    <td style="font-weight: 600; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right;">{{ $invite->name }}</td>
                                </tr>
                                <tr>
                                    <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06);">Email</td>
                                    <td style="font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right; color: #6a6a7a;">{{ $invite->email }}</td>
                                </tr>
                                <tr>
                                    <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06);">Phone</td>
                                    <td style="font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right; color: #6a6a7a;">{{ $invite->phone }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: #f7f5f2; border-radius: 10px; padding: 16px 20px; border: 1px solid rgba(166, 124, 78, 0.06); margin-bottom: 16px;">
                    <tr>
                        <td>
                            <h4 style="font-family: 'Georgia', serif; font-weight: 700; font-size: 14px; color: #a67c4e; margin: 0 0 10px 0;">&#128197; Event Details</h4>

                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06);">Event Name</td>
                                    <td style="font-weight: 600; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right; color: #a67c4e;">{{ $invite->event_name }}</td>
                                </tr>
                                <tr>
                                    <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06);">Event Date</td>
                                    <td style="font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right; color: #6a6a7a;">{{ $invite->event_date->format('M d, Y') }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right; color: #6a6a7a;">{{ $invite->location }}</td>
                                </tr>
                                @if($invite->expected_attendance)
                                    <tr>
                                        <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06);">Expected Attendance</td>
                                        <td style="font-weight: 500; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right; color: #6a6a7a;">{{ number_format($invite->expected_attendance) }}</td>
                                    </tr>
                                @endif
                                @if($invite->message)
                                    <tr>
                                        ...
                                        <td style="font-weight: 400; font-size: 12px; padding: 3px 0; border-bottom: 1px solid rgba(166, 124, 78, 0.06); text-align: right; color: #6a6a7a; line-height: 1.5;">{{ $invite->message }}</td>
                                    </tr>
                                @endif
                                <tr>
                                    <td style="color: #6a6a7a; font-weight: 500; font-size: 12px; padding-top: 3px;">Status</td>
                                    <td style="font-weight: 600; font-size: 12px; padding-top: 3px; text-align: right;">
