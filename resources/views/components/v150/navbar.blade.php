@php
    ...
    $isHeroPage = request()->routeIs('home') || request()->routeIs('about') || request()->routeIs('book.*') || request()->routeIs('resources') || request()->routeIs('events.*') || request()->routeIs('baptism') || request()->routeIs('invite');
